...
-- Création du schéma (optionnel, si tu veux tout mettre dedans)
CREATE SCHEMA IF NOT EXISTS video_games;
SET search_path TO video_games;
...
INSERT INTO genre (id, genre_name) OVERRIDING SYSTEM VALUE VALUES
(1,'Action'),
(2,'Adventure'),
(3,'Fighting'),
(4,'Misc'),
...
INSERT INTO publisher (id, publisher_name) OVERRIDING SYSTEM VALUE VALUES
(1,'10TACLE Studios'),
(2,'1C Company'),
...
-- (⚠️ suite des INSERTs identique à ton script, mais syntaxe PostgreSQL déjà compatible)
...
INSERT INTO region (id, region_name) OVERRIDING SYSTEM VALUE VALUES
(1,'North America'),
(2,'Europe'),
(3,'Japan'),
(4,'Other');
...
INSERT INTO platform (id, platform_name) OVERRIDING SYSTEM VALUE VALUES
(1,'Wii'),
(2,'NES'),
(3,'GB'),
(4,'DS'),
